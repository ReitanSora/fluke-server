...
/**
 * @class CMoveSongQueueTask
 * @brief Task that moves songs within the queue.
 *
 * This class implements the IAIMPTask interface and is used to query AIMP for
 * moving a given song within the queue.
 *
 ...
 */
class CMoveSongQueueTask : public IAIMPTask
{
private:
    /**
...
public:
     ...
     */
    CMoveSongQueueTask(MyPlugin* plugin, const int& _songIndex, const int& _targetIndex);
